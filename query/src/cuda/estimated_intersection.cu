#include "estimated_intersection.h"
...
__global__ void estimateKernel(
    ...
    // effective_prob = (MinkowskiVolume / CellVolume) * ShapeCorrection
    ...
    // Use geometric mean for shape correction (proven more robust for mixed shapes)
